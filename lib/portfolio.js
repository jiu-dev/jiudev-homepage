...
export const projets = [
  ...
  },
  {
    ...
    body: 'Space Portfolio est une vitrine numérique conçue pour mettre en avant mes compétences et réalisations en tant que développeur frontend. Ce portfolio est non seulement un reflet de mes compétences techniques, mais aussi de ma créativité et de ma vision en matière de design web.'
  }
]
